...
export default function(Business){
  ...
  Business.prototype.load = function(dataView){
    var _this = this;
    return Ajax.get("/operations/"+this.app.props.route+"?name=get"+dataView)
  ...
  Business.prototype.uploadImage = function(file){
    ...
    return Ajax.get("/operations/assets/sign"+query)
  ...
  Business.prototype.groupActions = function(action, rows){
    ...
    return Ajax.post("/operations/"+this.app.props.route + "?name=group/"+action, deltaRows)
  ...
  Business.prototype.rowAction = function(action, row){
    ...
    return Ajax.post("/operations/"+this.app.props.route + "?name=row/"+action,delta)
  ...
  Business.prototype.save = function(content){
    ...
    return Ajax.post("/operations/"+this.app.props.route,delta)
    .then(function(content){
      Contents.save(content);
      Contents.updateOriginal(content);
      _this.app.setState({ content: null })
