...
class LookUp extends React.Component {
  ...
  componentDidMount(){
    ...
    UI.updateLink(this);
    var selectedItem;
    this.props.items.forEach(function(item){ if(item.id == _this.props.selectedItem) selectedItem = item })
    this.setState({ items: this.props.items, selectedItem: selectedItem });
  }
  ...
  componentWillReceiveProps(nextProps){
    ...
    var selectedItem;
    nextProps.items.forEach(function(item){ if(item.id == nextProps.selectedItem) selectedItem = item })
    this.setState({ items: nextProps.items, selectedItem: selectedItem });
  }
  ...
  onItemSelect(item){
    ...
    this.props.onSelect(this.props.onSelectColumn, item.id);
  }
  ...
  renderLabel(){
    ...
    return <label className="slds-form-element__label" htmlFor="combobox-unique-id">{this.props.label}</label>;
  }
...
LookUp.demo = function(Highlight){
